//
//  HXPHPickerBottomViewConfiguration.swift
//  HXPHPickerExample
//
...
// MARK: 底部工具栏配置类
public class HXPHPickerBottomViewConfiguration: NSObject {
    ...
    /// 原图按钮选择框相关配置
    public lazy var originalSelectBox: HXPHSelectBoxConfiguration = {
    ...
    public var customSelectedViewCellClass: HXPHPreviewSelectedViewCell.Type?
