...
//    self.navigationController.navigationBar.translucent = NO;
    ...
    self.manager.configuration.photoEditConfigur.aspectRatio = HXPhotoEditAspectRatioType_None;
    self.manager.configuration.photoEditConfigur.isRoundCliping = NO;
