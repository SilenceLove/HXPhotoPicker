...
//     smooth.b = log(1.0 + 0.2 * smooth.b)/log(1.2);
     //调低比例
     smooth.r = log(1.0 + 0.2 * smooth.r)/log(1.205);
     smooth.g = log(1.0 + 0.2 * smooth.g)/log(1.205);
     smooth.b = log(1.0 + 0.2 * smooth.b)/log(1.205);
      //Damon end
     gl_FragColor = smooth;
 }
 );
...
- (id)initWithDegree:(float)degree
{
    ...
    // Third pass: combination bilateral, edge detection and origin
    combinationFilter = [[GPUImageCombinationFilter alloc] initWithDegree:degree];
    [self addFilter:combinationFilter];
